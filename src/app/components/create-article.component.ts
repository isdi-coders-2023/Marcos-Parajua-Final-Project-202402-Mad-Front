  ...
  template: `
    <div class="article-create-container">
      <div class="article-create-header__container">
        <h2 class="article-create-header">Write an Article.</h2>
      </div>
      ...
      >
        ...
        <input
          ...
          class="article-create-input"
        />
        <label for="content" class="article-create-label"
...
export default class createArticleComponent implements OnInit {
  currentUser!: User;
